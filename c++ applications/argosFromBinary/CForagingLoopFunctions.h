...
#ifndef ARGOSFROMBINARY_CFORAGINGLOOPFUNCTIONS_H
#define ARGOSFROMBINARY_CFORAGINGLOOPFUNCTIONS_H
...
public:
    ...
    virtual double getCollectedFood();
...
#endif //ARGOSFROMBINARY_CFORAGINGLOOPFUNCTIONS_H
